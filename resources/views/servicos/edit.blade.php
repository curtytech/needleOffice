    ...
    <form action="{{ route('atualizarServico', ['id' => $servicos->id]) }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <input type="text" class="form-control" id="servico" name="servico[]" placeholder="" value="{{$service}}">
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <input type="text" class="form-control" id="descServico" name="descServico[]" placeholder="" value="{{$descService}}">
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <input type="number" class="form-control" id="qtdServico" name="qtdServico[]" placeholder="" value="{{$qtdService}}">
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <div class="input-group mb-2 col-3">
                        ...
                        <input type="text" class="form-control" id="valServico" name="valServico[]" value="{{$valService}}">
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="row  mt-3">
            <div class="col-6 d-grid gap-2">
                ...
                <input type="button" id="addServico" class=" btn btn-secondary btn-sm" value="Adicionar mais serviços ">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 ">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <input type="number" class="form-control" id="qtdMaterial" name="qtdMaterial[]" value="{{$qtdMaterial}}">
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-3 ">
                ...
                <div class=" wrapper mb-2">
                    ...
                    <div class="input-group col-3">
                        <span class="input-group-text" id="basic-addon1">R$:</span>
                        <input type="text" class="form-control" id="valUnitarioMaterial" name="valUnitarioMaterial[]" value="{{$valUnitarioMaterial}}">
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="col-md-3 ">
                ...
                <div class=" wrapper ">
                    ...
                    <div class="input-group mb-2 col-3">
                        <span class="input-group-text" id="basic-addon1">R$:</span>
                        <input type="text" class="form-control" id="valTotalMaterial" name="valTotalMaterial[]" value="{{$valTotalMaterial}}">
                    </div>
                </div>
                @endforeach
            </div>
